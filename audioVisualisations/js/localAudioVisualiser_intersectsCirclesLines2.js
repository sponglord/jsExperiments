...
//        row += 1;
    ...
    function draw(freqIndex, amplitude, numSamples){
        ...
        var rgb = NN.utils.hsvToRGB([hue, sat, bright]);

        // Set stroke colour & width for primary circles
        canvCtx.strokeStyle = 'rgba(' + rgb[0] + ','  + rgb[1] + ',' + rgb[2] + ',' + 0.6 + ')';
        canvCtx.lineWidth = 1;
        ...
        if(lastCircle){
            ...
            if(intersect){
                ...
                canvCtx.fillStyle = '#000';// to fill instead of stroke

                // Set stroke colour & width for intersecting circles
                ...
                if(intersect.length > 2){
                    ...
                    canvCtx.beginPath();
                    canvCtx.arc(intersect[2], intersect[3], intersectRad, 0, Math.PI * 2, false);
                    canvCtx.fill()// to fill instead of stroke
                    canvCtx.stroke();
                    ...
                    // Draw line
                    canvCtx.beginPath();
                    canvCtx.moveTo(intersect[0], intersect[1] - intersectRad);
                    canvCtx.lineTo(intersect[2], intersect[3] + intersectRad);
                    canvCtx.stroke();
                }
